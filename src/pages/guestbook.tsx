      ...
      <main className="container mx-auto flex min-h-fit flex-col items-center justify-center p-2">
        ...
        {session?.user && (
          ...
          >
            ...
            <button
              type="submit"
              className="h-8 absolute right-1 top-3 flex w-28 items-center justify-center rounded bg-gray-100   font-medium text-gray-900 dark:bg-gray-700 dark:text-gray-100"
            >
              Post
            </button>
          </form>
